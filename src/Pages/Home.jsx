...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/keshabbhatt" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/keshab-raj-bhatt-64b083253/" },
  { icon: Instagram, link: "https://www.instagram.com/keshabrajbhatt12345?igsh=bXduM2U0YWZvdWpi" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Crafting Innovative Digital Experiences with Functionality and User-Centric Design.
                </p>
